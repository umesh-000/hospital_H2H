# Generated by Django 4.2.14 on 2024-09-20 12:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resume', models.FileField(blank=True, null=True, upload_to='doctors/doctor_documents/')),
                ('medical_license_doc', models.FileField(blank=True, null=True, upload_to='doctors/doctor_documents/')),
                ('certification', models.FileField(blank=True, null=True, upload_to='doctors/doctor_documents/')),
                ('other', models.FileField(blank=True, null=True, upload_to='doctors/doctor_documents/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
